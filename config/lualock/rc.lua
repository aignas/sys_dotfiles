...
-- {{{ lualock settings
style{ color = "#333333", font = "Inconsolata 11", x = 540, y = 400, off_x = 5,
        off_y = 6, width = 200, height = 24 }
...
user_text = odious.widget.text{ text = "User: " .. os.getenv("USER"), x = 540,
                                y = 370, font = "Inconsolata 14", color = "#ffffff",
